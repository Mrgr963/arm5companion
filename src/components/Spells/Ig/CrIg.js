  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b> Criar luz equivalente à luz da lua.
            </p>
            <p>
              <b>LVL 2: </b> Criar luz equivalente à luz de velas, ou Aquecer um
              objeto ao toque, ou Acender algo altamente inflamável, como óleo
              ou um pavio.
            </p>
            <p>
              <b>LVL 3: </b> Criar luz equivalente a uma tocha, ou Aquecer um
              objeto para ficar quente demais ao toque, ou Acender algo bastante
              inflamável, como pergaminho.
            </p>
            <p>
              <b>LVL 4: </b> Criar um fogo de +5 de dano, ou Criar luz tão
              brilhante quanto um dia nublado, ou Acender algo inflamável, como
              madeira seca ou carvão, ou Aquecer um objeto o suficiente para
              ferver água.
            </p>
            <p>Criar um fogo de +10 de dano.</p>
            <p>
              Criar um fogo de +5 de dano em um formato antinatural, como um
              anel, uma folha, ou cobrindo alguma coisa física.
            </p>
            <p>Criar luz tão brilhante quanto um dia de sol.</p>
            <p>Acender algo pouco inflamável (como couro ou madeira úmida).</p>
            <p>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Criar um fogo de +15 de dano.</p>
            <p>Criar um fogo de +10 de dano em um formato antinatural.</p>
            <p>
              Acender algo quase bem pouco inflamável, como um corpo humano.
            </p>
            <p>Aquecer um objeto o suficiente para derreter chumbo.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Criar um fogo de +20 de dano.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Criar um fogo de +25 de dano.</p>
            <p>Criar um fogo de +20 de dano em um formato antinatural.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Criar um fogo de +30 de dano.</p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Creo Ignem</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
          <b>Magias que criam fogo são armas versáteis são avassaladoras contra
            coisas vivas, mortos-vivos, construções e até a moral do inimigo.
            Mas aqueles que confiam nas magias de fogo sempre arriscam a Falha
            Crítica. O fogo é um elemento implacável para aqueles que perdem seu
            controle e é sempre possível queimar a si mesmo.</b>
          </p>
          <p className="guideContenttxt">
            Algumas Insígnias típicas produzem fogo de uma cor ou formato
            específico, ou até mesmo um aroma.
          </p>
        </div>
      </div>
