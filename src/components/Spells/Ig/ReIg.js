  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>GERAL: </b> Criar uma barreira contra criaturas do fogo
            ...
            <p>
              <b>LVL 3: </b> Controlar um fogo de maneira natural (controlas seu
              movimento ou velocidade, por exemplo), ou Mover um fogo
              rapidamente enquanto continua queimando naturalmente.
            </p>
            <p>
              <b>LVL 4: </b> Controlar um fogo de maneira um pouco antinatural
              (como impedir que queime alguém, por exemplo)
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Controlar um fogo de maneira completamente antinatural (na forma
              de um fogo humanoide dançarino, por exemplo)
            </p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Rego Ignem</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
          <b>  A intensidade de um fogo também afeta a dificuldade de controlá-lo.
            Para cada cinco pontos acima de +5 de Dano causado por um fogo,
            adicione uma magnitude ao efeito.</b>
          </p>
          <p className="guideContenttxt">
            Magias Rego Ignem podem controlar calor, luz e fogo.
          </p>
          <p className="guideContenttxt">
          <b>Falhas Críticas de ReIg geralmente causam comportamentos opostos aos
            desejados pelo magus.</b>
          </p>
        </div>
      </div>
