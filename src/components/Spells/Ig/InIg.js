  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b>Descobrir uma propriedade de um fogo, ou Localizar
              um fogo.
            </p>
            <p>
              <b>LVL 2: </b> Descobrir todas as propriedades de um fogo, ou Ter
              consciência de todos os fogos dentro da área afetada, ou
              Visualizar um fogo através de uma Conexão Arcana, ou Sentir níveis
              de calor.
            </p>
            <p>
              <b>LVL 3: </b> Descobrir todas as propriedades de cinzas, ou
              Detectar traços de fogos no último mês lunar.
            </p>
            <p>
              <b>LVL 4: </b> Enxergar normalmente através de um fog (pode ser
              necessário um requisito Auram caso haja fumaça também), ou
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Visualizar um fogo através de uma Conexão Arcana, assim como tudo
              o que ele ilumina com sua luz. (visualizar uma fogueira e tudo
              dentro do seu círculo de luz, por exemplo)
            </p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Intellego Ignem</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
          <b>Falhas Críticas de InIg normalmente geram informações erradas, mas
            também podem deixar o magus incapaz de perceber calor ou fogo por um
            tempo.</b>
          </p>
        </div>
      </div>
