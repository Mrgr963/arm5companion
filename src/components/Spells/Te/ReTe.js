  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>GERAL: </b> Criar uma barreira contra criaturas da terra
            ...
            <p>
              <b>LVL 1: </b> Controlar ou mover terra de maneira natural.
            </p>
            <p>
              <b>LVL 2: </b> Controlar ou mover terra de maneira antinatural, ou
              Manter terra à distância, contanto que o magus esteja ciente dela.
            </p>
            <p>
              <b>LVL 3: </b> Controlar ou mover terra de maneira extremamente
              antinatural.
            </p>
            <p>
              Manter toda terra à distância ou criar uma barreira contra terra.
            </p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Rego Terram</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            As referências para o controle de terra, areia, lama ou argila estão
            listadas abaixo. Adicione uma magnitude para controlar pedra ou
            vidro e duas para metais ou pedras preciosas. A manipulação de
            objetos com grande precisão também pode exigir magnitude maior,
            dependendo do nível de precisão.
          </p>
          <p className="guideContenttxt">
          <b>Falhas Críticas ReTe muitas vezes fazem com que o magus seja
            atingido por grandes quantidades de pedras voadoras.</b>
          </p>
        </div>
      </div>
