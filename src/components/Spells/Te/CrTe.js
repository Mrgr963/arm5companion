  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b> Criar areia, terra, lama ou barro.
            </p>
            <p>
              <b>LVL 3: </b> Criar pedra ou vidro.
            </p>
            <p>Criar metais básicos</p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Creo Terram</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
          <b>Para criar terra em um formato elaborado, ou com alguma propriedade
            antinatural, adicione um nível de magnitude.</b>
          </p>
          <p className="guideContenttxt">
            As Insígnias Místicas visíveis com Creo Terram geralmente afetam o
            material ou objeto criado de maneira bizarra, como uma cor ou
            textura antinatural.
          </p>
          <p className="guideContenttxt">
          <b>Falhas Críticas CrTe podem encapsular o magus em pedra, criar o tipo
            de material errado ou criar algo em lugar diferente.</b>
          </p>
        </div>
      </div>
