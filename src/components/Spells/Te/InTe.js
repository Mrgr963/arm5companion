      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 2: </b> Falhas Críticas InTe normalmente geram informações erradas.
            </p>
            <p>
              <b>LVL 4: </b> Descobrir uma propriedade mundana de um objeto, ou Enxergar um objeto e os seus arredores.
            </p>
            <p>Descobrir todos os componentes de uma mistura ou liga metálica.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Descobrir todas as propriedades naturais de um objeto.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Sentir todas as propriedades mundanas de um objeto composto.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Descobrir as propriedades mágicas de um objeto. Fazer com que seus sentidos não sejam afetados pela terra (enxergar através de
uma rocha, por exemplo).</p>
<p>Conversar com uma rocha natural (uma pedra ou rochedo não esculpidos, por exemplo).</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Conversar com uma rocha artificial (uma estátua, por exemplo).</p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Intellego Terram</h1>
        <div className="guideContent">
          <p className="guideContenttxt">O nível das magias Intellego Terram não é afetado pelo material.</p>
          <p className="guideContenttxt"><b>Falhas Críticas InTe normalmente geram informações erradas.</b></p>
        </div>
      </div>
