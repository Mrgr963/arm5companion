  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 2: </b> Enfraquecer terra.
            </p>
            <p>
              <b>LVL 3: </b> Destruir terra.
            </p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Perdo Terram</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Para destruir areia, lama ou argila, use o mesmo nível de magnitude
            que para terra. Para destruir pedra ou vidro, adicione um nível de
            magni- tude. Para destruir metais ou pedras preciosas, adicione dois
            níveis de magnitude.
          </p>
          <p className="guideContenttxt">
          <b>Falhas Críticas PeTe, assim como podem destruir a coisa errada,
            podem destruir o chão sob o magus ou objetos de metal que ele esteja
            segurando.</b>
          </p>
        </div>
      </div>
