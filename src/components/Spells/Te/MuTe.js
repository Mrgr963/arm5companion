  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b> Alterar uma propriedade de terra.
            </p>
            <p>
              <b>LVL 2: </b> Transformar terra em outro tipo de material (areia em argila, por exemplo).
            </p>
            <p>
              <b>LVL 3: </b> Alterar terra de maneira levemente antinatural (com os requisitos apropriados), ou Transformar terra em um líquido ou gás (com os requisitos apropriados), ou Transformar terra em pedra, ou vice-versa.
            </p>
            <p>
              <b>LVL 4: </b> Alterar terra de maneira extremamente antinatural (com os requisitos apropriados), ou Transformar terra em uma mistura de sólidos, líquidos e gases (com requisitos), ou Transformar terra em uma planta (com requisito), ou Transformar terra em uma planta (com requisito).
            </p>
            <p>Transformar terra em um líquido ou gás levemente antinatural (com requisitos)</p>
            <p>Transformar terra em um animal (com requisito).</p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td className="effectTxt">
            <p>Transformar terra em um líquido ou gás extremamente antinatural (com requisitos).</p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Muto Terram</h1>
        <div className="guideContent">
          <p className="guideContenttxt"><b>Os níveis abaixo consideram a transformação de terra. Para incluir areia, argila ou lama na transformação, seja na forma inicial ou na final, os
...
transformação, adicione dois níveis.</b></p>
          <p className="guideContenttxt">A quantidade de material transformada é limitada pelas referências dos materiais envolvidos. É possível transformar um metro cúbico de
granito em uma polegada cúbica de rubi com um Indivíduo Padrão, por exemplo.</p>
          <p className="guideContenttxt"><b>Falhas Críticas MuTe graves tendem a transformar o magus em pedra ou metal, mas Falhas Críticas menos graves transformam o alvo
errado, ou de maneira errada.</b></p>
        </div>
      </div>
