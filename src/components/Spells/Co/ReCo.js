  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>GERAL: </b> Criar uma barreira contra criaturas associadas a
              Corpus e a um dos Reinos Míticos (Divino, Feérico, Infernal,
              Mágico) de Potência igual ou inferior ao nível da magia (Alc:
              Toque, Dur: Círculo, Alv: Círculo). Lembre-se que magi herméticos
              não têm Potência e, portanto, não são afetados por barreiras deste
              tipo.
            </p>
            <p>
              <b>LVL 2: </b>Tomar o controle de alguma parte do corpo do alvo.
            </p>
            <p>
              <b>LVL 3: </b> Mover o alvo lentamente em uma única direção,
              contanto que a superfície suporte seu peso.
            </p>
            <p>
              <b>LVL 4: </b> Controlar os movimentos amplos do alvo, ou Mover o
              alvo lentamente em qualquer direção, ou Mover o alvo diretamente
              para cima, ou em uma única direção, mesmo sem superfícies de
              apoio.
            </p>
            <p>Manter um alvo paralisado.</p>
            <p>
              Mover o alvo lentamente em qualquer direção, sem a necessidade de
              qualquer suporte.
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>Controlar os todos os movimentos de um corpo.</p>
            <p>Eliminar as penalidades por Fadiga ou Ferimentos.</p>
            <p>Animar um cadáver.</p>
            <p>
              Transportar instantaneamente o alvo a até um metro e meio de
              distância.
            </p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Rego Corpus</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
          <b> Falhas Críticas de ReCo costumam tomar o controle do corpo do magus,
            movendo-o de maneiras adversas.</b>
          </p>
        </div>
      </div>
