  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 3: </b> Causar dano superficial a um corpo (remover todos
              os pelos, por exemplo).
            </p>
            <p>
              <b>LVL 4: </b> Causar dor a alguém, sem dano verdadeiro.
            </p>
            <p>Infligir um Ferimento Leve.</p>
            <p>Destruir um cadáver.</p>
            <p>
              Causar uma deficiência em um corpo, sem dano efetivo, como deixar
              alguém coxo ou deixar sua visão turva. Considere como um Ferimento
              Leve para efeitos de cura.
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>Infligir um Ferimento Médio.</p>
            <p>Consumir um ponto de fadiga.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Envelhecer um corpo o equivalente a cinco anos.</p>
            <p>
              Partir um membro, deixando o inutilizável (mas ainda passível de
              ser curado). Considere como um Ferimento Médio para efeitos de
              cura.
            </p>
            <p>Destruir um dos sentidos menores.</p>
            <p>Infligir um Ferimento Grave.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Destruir um dos sentidos maiores. Considere como um Ferimento
              Grave para efeitos de cura.
            </p>
            <p>Gerar uma doença grave.</p>
            <p>
              Destruir ou decepar um membro, de modo que não pode ser curado
              naturalmente.
            </p>
            <p>Infligir um Ferimento Incapacitante.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Destruir uma propriedade de um corpo, como a sua solidez ou seu
              peso.
            </p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Perdo Corpus</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Essas magias infligem dano direto e geralmente permanente, a não ser
            que outras magias sejam usadas para curar o dano causado.
          </p>
          <p className="guideContenttxt">
          <b>Doenças causadas por magia têm uma Dificuldade Básica 6. Para cada
            magnitude adicionada à magia, a Dificuldade recebe um bônus de +1.
            Não é possível reduzir o nível da magia para diminuir a Dificuldade
            abaixo de 6 (veja a página 254 para mais informações sobre doenças).</b>
          </p>
        </div>
      </div>
