  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 3: </b> Localizar uma pessoa com o uso de uma Conexão
              Arcana.
            </p>
            <p>
              <b>LVL 4: </b> Descobrir informações gerais sobre um corpo.
            </p>
            <p>Descobrir uma informação específica sobre um corpo.</p>
            <p>Conversar com um cadáver.</p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td className="effectTxt">
            <p>Descobrir todas as informações úteis sobre um corpo.</p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Intellego Corpus</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Insígnias comuns em magias Intellego Corpus tendem a relatar as
            informações de maneira peculiar.
          </p>
          <p className="guideContenttxt">
          <b> Como a maioria dos casos com magia Intellego, Falhas Críticas InCo
            geralmente resultam em informações erradas.</b>
          </p>
        </div>
      </div>
