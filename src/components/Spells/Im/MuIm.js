  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b> Alterar um aspecto da percepção de um objeto (fazer
              uma folha parecer uma moeda, por exemplo), mas não o tipo (de
              visual para auditivo, por exemplo).
            </p>
            <p>
              <b>LVL 2: </b> Alterar dois aspectos da percepção de um objeto.
            </p>
            <p>
              <b>LVL 3: </b> Alterar três aspectos da percepção de um objeto.
            </p>
            <p>
              <b>LVL 4: </b>Alterar quatro aspectos da percepção de um objeto.
            </p>
            <p>
              Alterar completamente a percepção de um objeto, em todos os
              sentidos – exceto o táctil.
            </p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Muto Imaginem</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            São magias poderosas e bastante úteis, capazes de alterar a
            percepção visual, auditiva, olfativa ou gustativa de um objeto ou
            ser. A imagem se mantém alterada independente da concentração do
            magus e se adapta ao meio. A acurácia de uma cópia depende do
            conhecimento do magus em relação à imagem original. Para recriar
            efetivamente a voz de uma pessoa específica, por exemplo, o magus
            precisa conhecer bem tal pessoa. É possível que as pessoas mais
            íntimas consigam discernir ilusões (“Duke Tybol, sua cicatriz não é
            do lado esquerdo do rosto?”).
          </p>
          <p className="guideContenttxt">
          <b> Falhas Críticas MuIm costumam alterar a aparência do magus de
            maneira perigosa ou humilhante.</b>
          </p>
        </div>
      </div>
