  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 2: </b> Falhas Críticas ReIm podem controlar a imagem
              errada, ou afetar o alvo de maneira completamente inapropriada.
            </p>
            <p>
              <b>LVL 3: </b> Falhas Críticas ReIm podem controlar a imagem
              errada, ou afetar o alvo de maneira completamente inapropriada, ou
              Fazer com que objetos pareçam estar se movendo rapidamente,
              gerando confusão.
            </p>
            <p>
              <b>LVL 4: </b> Fazer com que um objeto pareça (para um sentido)
              estar a até quinze metros de sua posição real, ou Fazer com que um
              objeto pareça estar contido ou colado a outro objeto, definido
              quando a magia é conjurada (fazer com que a voz de uma pessoa soe
              como se estivesse saindo de uma caixa, por exemplo).
            </p>
            <p>
              Fazer com que um objeto pareça (para um sentido) estar a até cem
              metros de sua posição real.
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Fazer com que um objeto pareça (para um sentido) estar em qualquer
              lugar que o magus puder enxergar (Duração: Visão).
            </p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Fazer com que um objeto pareça (para um sentido) estar em qualquer
              lugar para onde o magus possua uma Conexão Arcana.
            </p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Rego Imaginem</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Estas magias fazem com que as coisas pareçam estar em outros
            lugares. Assim como CrIm e PeIm, é mais difícil afetar imagens
            dinâmicas, exigindo uma magnitude adicional. Caso a imagem se
            modifique em conjunto com o objeto, adicione mais uma magnitude.
            Além disso, cada sentido afetado pela ilusão adiciona mais uma
            magnitude.
          </p>
          <p className="guideContenttxt">
          <b>  Falhas Críticas ReIm podem controlar a imagem errada, ou afetar o
            alvo de maneira completamente inapropriada.</b>
          </p>
        </div>
      </div>
