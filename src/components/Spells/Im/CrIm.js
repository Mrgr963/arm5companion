  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b> Criar uma imagem que afete um único sentido.
            </p>
            <p>
              <b>LVL 2: </b> Criar uma imagem que afete dois sentidos.
            </p>
            <p>
              <b>LVL 3: </b> Criar uma imagem que afete três sentidos.
            </p>
            <p>
              <b>LVL 4: </b> Criar uma imagem que afete quatro sentidos.
            </p>
            <p>Criar uma imagem que afete cinco sentidos.</p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Creo Imaginem</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Essas magias criam e restauram imagens. É importante notar que
            magias Creo Imaginem geram apenas as imagens das coisas e não as
            coisas propriamente ditas. Uma imagem de um balde não será capaz de
            carregar qualquer quantidade de água que jorre para dentro dela,
            assim como a imagem de um cavalo não é capaz de ser cavalgada. Esta
            é a maior indicação possível e muitas vezes a primeira, de que se
            trata de uma ilusão. Por outro lado, a ilusão de um muro pode
            parecer sólida ao toque, mas não oferece resistência caso alguém
            tenta empurrá-la.
          </p>
          <p className="guideContenttxt">
          <b> Aumentar a complexidade de uma percepção sensorial, como criar uma
            imagem em movimento, ou o som de palavras ao invés de barulho, exige
            um nível de magnitude adicional. Uma imagem que se mova ou emita
            sons em direção ao magus, à medida que ele se concentra, exige dois
            níveis adicionais de magnitude. Imagens extremamente intrincadas
            (como uma ponte ricamente entalhada ou esculpida) normalmente exigem
            mais um nível de magnitude.</b>
          </p>
          <p className="guideContenttxt">
            As Insígnias Místicas tendem a ser bastante óbvias em magias Creo
            Imaginem. As ilusões geralmente apresentam algum traço
            característico capaz de ligá-las aos magi que as criaram. As ilusões
            criadas por Fortunatus de Jerbiton, por exemplo, costumam ter algum
            ícone religioso em tamanho reduzido, devido ao seu método de criação
            de magias.
          </p>
          <p className="guideContenttxt">
          <b> As Falhas Críticas CrIm podem gerar ilusões óbvias, prontamente
            identificáveis como tal e claramente ligadas ao magus –
            identificando-o como um feiticeiro.</b>
          </p>
        </div>
      </div>
