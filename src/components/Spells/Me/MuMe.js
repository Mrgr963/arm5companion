  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b> Alterar minimamente a memória de alguém acerca de um evento.
            </p>
            <p>
              <b>LVL 2: </b> Alterar drasticamente a memória de alguém acerca de um evento.
            </p>
            <p>
              <b>LVL 3: </b> Alterar drasticamente a memória de alguém em um conjunto de eventos, ou Alterar drasticamente uma emoção de alguém.
            </p>
            <p>
              <b>LVL 4: </b> Alterar drasticamente as memórias de alguém de um período de sua vida, ou Alterar completamente as emoções de alguém.
            </p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Reescrever completamente as memórias de alguém.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Tornar uma mente ou um espírito visíveis (Requisito Imaginem).</p>
            <p><p>Tornar uma mente ou um espírito visíveis (Requisito Imaginem).</p></p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Tornar uma mente ou espírito sólidos (Requisito de acordo com a Forma do formato assumido)</p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Muto Mentem</h1>
        <div className="guideContent">
          <p className="guideContenttxt">Magias Muto Mentem conferem às mentes propriedades que estas não poderiam ter naturalmente. Há três categorias principais. A primeira
...
de animais e criaturas similares. A terceira envolve propriedades não mentais, como tornar uma mente tangível – algo bastante difícil de realizar.</p>
          <p className="guideContenttxt"><b>Falhas Críticas de MuMe podem alterar a mente do magus, tornando-as especialmente arriscadas.</b></p>
          <p className="guideContenttxt"><b>Conferir um Sentido Mágico a um grupo de pessoas tem um nível básico uma magnitude maior do que o mesmo efeito usando Intellego
para um único alvo. Esta magnitude a mais não inclui os aumentos necessários em Alcance e Alvo.</b></p>
        </div>
      </div>
