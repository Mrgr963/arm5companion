  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 3: </b> Remover um detalhe pequeno da memória de alguém.
            </p>
            <p>
              <b>LVL 4: </b> Remover um detalhe importante da memória de alguém, ou Diminuir uma capacidade mental do alvo, ou Reduzir a intensidade de todas as emoções do alvo.
            </p>
            <p>Extinguir uma emoção em uma pessoa.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Remover uma memória pequena ou de curto prazo de alguém.</p>
            <p>Reduzir todas as capacidades mentais do alvo.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Remover uma memória grande ou de longo prazo de alguém.</p>
            <p>Remover todas as emoções de alguém.</p>
            <p>Causar insanidade em uma pessoa.</p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Destruir a mente de alguém, deixando-o vazio por dentro.</p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Perdo Mentem</h1>
        <div className="guideContent">
          <p className="guideContenttxt">As emoções ressurgem naturalmente e magias que as destroem precisam durar um bom tempo para garantir que não retornem. As memórias
...
impediria que memórias fossem recuperadas.</p>
          <p className="guideContenttxt"><b>Falhas Críticas PeMe podem destruir mais do que intencionado, ou até mesmo elementos da mente do próprio magus.</b></p>
        </div>
      </div>
