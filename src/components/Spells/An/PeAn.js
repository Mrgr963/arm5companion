  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 2: </b> Danificar algum produto de origem animal.
            </p>
            <p>
              <b>LVL 3: </b> Causar danos superficiais a um animal (como remover
              seus pelos).
            </p>
            <p>
              <b>LVL4: </b> Destruir algum produto de origem animal, ou Causar
              dor a um animal, sem dano real, ou fazer com que um animal perca
              um ponto de fadiga.
            </p>
            <p></p>
            <p>
              Destruir um animal sem feri-lo, como tornar um cavalo coxo, deixar
              um pássaro sem voz ou uma serpente sem escamas. Este dano corta a
              efetividade do aspecto afetado pela metade. A recuperação é
              equivalente a um Ferimento Leve.
            </p>
            <p>Destruir o cadáver de um animal.</p>
            <p>Causar um Ferimento Leve.</p>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>Destruir um dos sentidos menores de um animal.</p>
            <p>Causar um Ferimento Grave</p>
            <p>
              Tornar um dos membros de um animal inutilizável, embora ainda
              possível de cura.
            </p>
            <p>
              Envelhecer um animal um doze avos de sua vida. Apenas afeta
              animais que tenham atingido maturidade completa.
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>Causar um Ferimento Incapacitante.</p>
            <p>
              Destruir ou decepar um dos membros de um animal, de modo que é
              impossível curá-lo normalmente.
            </p>
            <p>Destruir um dos sentidos principais de um animal.</p>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Destruir uma das propriedades de um animal, como seu peso ou
              agressividade..
            </p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Perdo Animal</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
          <b> Normalmente não há Absorção a Perdo Animal - a magia não cria algo
            que causa dano, ela simplesmente causa o dano em sí. Resistência
            Mágica é o único jeito de negar dano.</b>
          </p>
          <p className="guideContenttxt">
            Uma insígnia comum entre os magi Flambeau e outros que usam magias
            Perdo, é deixar alguma marca visível junto do dano que causam.
          </p>
          <p className="guideContenttxt">
          <b> Consulte as Referências Perdo Corpus também quando inventar novas
            magias Perdo Animal.</b>
          </p>
          <p className="guideContenttxt">
