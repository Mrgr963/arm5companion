  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b> Ter uma imagem mental do animal.
            </p>
            <p>
              <b>LVL 3: </b> Sentir o estado de consciência de um animal. Obter
              informações gerais sobre seu corpo.
            </p>
            <p>
              <b>LVL4: </b> Sentir a motivação primária de um animal. Descobrir
              um fato específico sobre seu corpo.
            </p>
            <p></p>
            <p>
              Descobrir a origem, idade e história de algum produto de origem
              animal.
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Falar com um animal. Ler os pensamentos de algum produto de origem
              animal.
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>Ler as memórias recentes de um animal.</p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td className="effectTxt">
            <p>Investigar cuidadosamente a mente de um animal.</p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Intellego Animal</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Quando tentar extrair informações de um animal, lembre-se de que as
            memórias são formadas através do estímulo dos sentidos, com suas
            vantagens e desvantagens, de acordo com cada animal. Cães, por
            exemplo, lembram muito mais dos odores particulares de cada coisa e
            pouco da aparência. Animais não se lembram de palavras ditas, mas
            podem lembrar-se do tom de voz e postura. É possível que você não
            consiga a informação exata que está procurando.
          </p>
          <p className="guideContenttxt">
            Para se comunicar com um animal é necessário adequar-se ao seu nível
            mental, um processo que pode causar efeitos temporários estranhos.
            Você pode ficar com uma vontade insaciável de carne crua, por
            exemplo, ou falar muito lentamente após ter conversado com um urso.
          </p>
          <p className="guideContenttxt">
          <b> Como Animal inclui aspectos de Corpus e Mentem em relação aos
            animais, as referências de ambas podem ser usadas para criar Bases
            novas.</b>
          </p>
          <p className="guideContenttxt">
           <b> Falhas Críticas de InAn geralmente resultam em informações erradas.</b>
          </p>
        </div>
      </div>
