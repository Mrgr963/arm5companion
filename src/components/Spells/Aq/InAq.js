  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b> Fazer com que um sentido não seja afetado por água.
            </p>
            <p>
              <b>LVL 2: </b>Ter um vislumbre de água nas proximidades.
            </p>
            <p>
              <b>LVL3: </b> Ter uma visão de água seus arredores dentro do
              alcance, ou Descobrir as propriedades naturais de um líquido.
            </p>
            <p>
              <b>LVL 4: </b> Descobrir as propriedades naturais de uma mistura
              de líquidos.
            </p>
            <p>Descobrir as propriedades mágicas de um líquido.</p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td className="effectTxt">
            <p>Descobrir as propriedades mágicas de uma mistura de líquidos.</p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td className="effectTxt">
            <p>Falar com um corpo d’água natural.</p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td className="effectTxt">
            <p>Falar com um corpo d’água artificial (como uma fonte).</p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Intellego Aquam</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Note que as magias Intellego Aquam não precisam de requisitos
            dependendo do líquido afetado.
          </p>
          <p className="guideContenttxt">
            A maioria das Insígnias se manifestam na maneira como a informação
            se manifesta. Na versão de Chavin de Tytalus de A Voz do Lago (InAq
            25) o lago sempre soa masculino, forte e arrogante.
          </p>
          <p className="guideContenttxt">
          <b>Falhas Críticas de InAq normalmente geram informações erradas.</b>
          </p>
        </div>
      </div>
