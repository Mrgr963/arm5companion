  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 4: </b> Secar alguma coisa completamente (até o tamanho de
              uma casa pequena.).
            </p>
            <p>
              Reduzir drasticamente a quantidade de líquido, sem eliminá-lo
              completamente.
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>Destruir um líquido. (requisitos variáveis).</p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td className="effectTxt">
            <p>
              Destruir uma propriedade de algum líquido (como a capacidade
              intoxicante do álcool, ou o gosto salgado do mar).
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Destruir uma pequena nascente, para que ela jamais volte a brotar.
            </p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Perdo Aquam</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Essas magias ficam mais sutis e difusivas à medida em que as
            magnitudes aumentam. Insígnias Perdo Aquam geralmente se manifestam
            em maneiras distintas de destruição. <b>Destruir água ou outro
            líquido dentro de algo, como os líquidos dentro de um corpo humano,
            usa Alvo: Parte. Destruir água ou outros líquidos exteriores a algo,
            mesmo que o esteja tocando, como a água no corpo e roupas de alguém
            molhado, usa Alvo: Indivíduo.</b>
          </p>
          <p className="guideContenttxt">
          <b> Falhas Críticas PeAq podem destruir a água dentro do magus, como a
            magia Maldição do Deserto (PeAq 25), ou criar água ao invés de
            destruí-la.</b>
          </p>
        </div>
      </div>
