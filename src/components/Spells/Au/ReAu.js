  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>GERAL: </b> Criar uma barreira contra criaturas do ar alinhadas
              a um dos Reinos Míticos (Divino, Feérico, Infernal ou Mágico) de
              Potência igual ou inferior ao nível da magia (Alc: Toque, Dur:
              Círculo, Alv: Círculo).
            </p>
            <p>
              <b>LVL 2: </b> Controlar um pequeno fenômeno meteorológico.
            </p>
            <p>
              <b>LVL 3: </b> Controlar um fenômeno meteorológico padrão, ou
              Proteger alguém contra um tipo de fenômeno meteorológico pequeno.
            </p>
            <p>
              <b>LVL 4: </b> Controlar um fenômeno meteorológico grande, ou
              Proteger alguém contra um tipo de fenômeno meteorológico padrão.
            </p>
            <p>Controlar um fenômeno meteorológico enorme.</p>
            <p>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Proteger alguém contra um tipo de fenômeno meteorológico enorme.
            </p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Rego Auram</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
          <b>Essas magias permitem que o magus controle fenômenos meteorológicos
            pré-existentes. Não é possível criar uma brisa com Rego Auram, mas é
            possível direcionar uma tempestade. Magias Rego Auram também podem
            causar ou parar uma chuva.</b>
          </p>
          <p className="guideContenttxt">
            Controlar uma quantidade de ar que grande força ou precisão aumenta
            a magnitude do efeito em +1.
          </p>
        </div>
      </div>
