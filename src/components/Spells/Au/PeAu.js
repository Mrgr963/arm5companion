  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 3: </b>Deixar o ar abafado e ruim para respirar.
            </p>
            <p>
              <b>LVL 4: </b>Destruir ar parado, ou Destruir um pequeno fenômeno
              meteorológico: uma brisa, névoa ou garoa leve, ou Reduzir a
              intensidade de um fenômeno meteorológico em um grau (de enorme
              para grande, por exemplo, ou de padrão para pequeno).
            </p>
            <p>
              Destruir um fenômeno meteorológico padrão: uma nuvem, vento,
              nevoeiro, chuva de uma nuvem existente.
            </p>
            <p>
              Destruir um fenômeno meteorológico padrão: uma nuvem, vento,
              nevoeiro, chuva de uma nuvem existente.
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Destruir um fenômeno meteorológico grande: uma trovoada
              retumbante, uma chuva torrencial, uma nevoeiro impenetrável, ou um
              vendaval.
            </p>
            <p>
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Destruir um fenômeno meteorológico enorme: furacão, relâmpago,
              tornado.
            </p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Perdo Auram</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Destruir ar com grande precisão aumenta a magnitude do efeito em +1
            ou mais.
          </p>
        </div>
      </div>
