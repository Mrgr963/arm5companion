  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b>Fazer com que seus sentidos não sejam afetados pelo
              ar (você pode ouvir normalmente durante uma tempestade, por
              exemplo).
            </p>
            <p>
              <b>LVL 2: </b> Descobrir uma propriedade do ar (determinar se é
              respirável, por exemplo).
            </p>
            <p>
              <b>LVL3: </b> Descobrir todas as propriedades do ar. Ter alguma
              intuição em relação a um fato ligado ao ar.
            </p>
          </td>
        </tr>
        <tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Intellego Auram</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
          <b> Falhas Críticas de InAu normalmente geram informações erradas.</b>
          </p>
        </div>
      </div>
