  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>GERAL: </b> Transformar o ar em um gás que cause (+Nível) de
              Dano.
            </p>
            <p>
              <b>LVL 3: </b> Transformar uma quantidade de ar em outro tipo de
              ar.
            </p>
            <p>
              <b>LVL 4: </b> Transformar uma quantidade de ar em outro elemento
              (fogo, terra ou água).
            </p>
            <p>
              Transformar uma quantidade de ar em uma mistura de elementos.
              Transformar uma quantidade de ar em algo seminatural.
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>
              Transformar uma quantidade de ar em algo completamente
              antinatural.
            </p>
          </td>
        </tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Muto Auram</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Transformar apenas uma propriedade do vento geralmente diminui 1
            nível do efeito.
          </p>
          <p className="guideContenttxt">
          <b>Falhas Críticas de MuAu podem transformar o magus temporariamente em
            ar, ou transformar o vento em algo indesejável.</b>
          </p>
        </div>
      </div>
