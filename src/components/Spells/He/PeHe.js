  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 2: </b> Fazer com que as folhas de uma árvore caiam.
            </p>
            <p>
              <b>LVL 3: </b> Estragar uma quantidade básica de grãos.
            </p>
            <p>
              <b>LVL 4: </b> Destruir uma quantidade básica de madeira morta.
            </p>
            <p>Destruir uma planta.</p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Perdo Herbam</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            Estas magias destroem plantas e objetos de origem vegetal. Como a
            maioria dos objetos são feitos de madeira, elas podem ser bastante
            des- trutivas. Os parâmetros abaixo servem para destruir madeira
            morta. Madeira viva é um pouco mais difícil de ser destruída –
            adicione uma magnitude ao nível do parâmetro desejado.
          </p>
          <p className="guideContenttxt">
          <b>Falhas Críticas de PeHe geralmente destroem objetos errados,
            possivelmente parte do vestuário do magus.</b>
          </p>
        </div>
      </div>
