  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>LVL 1: </b> Obter um conhecimento intuitivo de uma planta
              (saber se alguma ação será prejudicial a uma planta, por exemplo).
            </p>
            <p>
              <b>LVL 2: </b> Localizar uma planta.
            </p>
            <p>
              <b>LVL 3: </b> Descobrir informações gerais, ou uma informação
              específica sobre uma planta ou item feito de produtos vegetais.
            </p>
            <p>
              <b>LVL 4: </b> Descobrir todas as propriedades de uma planta ou
              item feito de produtos vegetais.
            </p>
          </td>
        </tr>
        <tr>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Intellego Herbam</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
          <b>Como a maioria das magias Intellego, Falhas Críticas de InHe geram
            informações erradas.</b>
          </p>
        </div>
      </div>
