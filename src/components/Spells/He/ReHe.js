  ...
  return (
    <div>
      ...
      <div className="effectsContainer">
        ...
        <tr>
          ...
          <td className="effectTxt">
            <p>
              <b>GERAL: </b> Criar uma barreira contra criaturas das florestas
            ...
            <p>
              <b>LVL 3: </b> Controlar uma quantidade básica de madeira.
            </p>
            <p>
              <b>LVL 4: </b>Desviar um ataque de uma arma de madeira, ou
              Controlar uma planta inteira, movendo-a conforme os desejos do
              magus, embora a raiz não possa ser movida.
            </p>
            <p>
              Controlar uma planta inteira, movendo-a conforme os desejos do
              magus, podendo inclusive transferir as raízes de lugar.
            </p>
            <p>Conjura uma planta capaz de se mover.</p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td className="effectTxt">
            <p>
              Fazer com que uma planta, ou objeto de origem vegetal se mova com
              propósito e inteligência, sem a necessidade de con- trole
              constante.
            </p>
          </td>
        </tr>
        <tr>
          ...
          <td className="effectTxt">
            <p>Proteger o alvo de produtos mundanos de origem vegetal.</p>
            <p>Fazer com que uma árvore floresça fora da estação.</p>
            <p>Tecer linha no formato de uma vestimenta.</p>
          </td>
        </tr>
      </div>
      ...
      <div className="guideTxt">
        <h1 className="guideTitle">Guidelines - Rego Herbam</h1>
        <div className="guideContent">
          <p className="guideContenttxt">
            É igualmente fácil controlar madeira viva ou morta.
          </p>
          <p className="guideContenttxt">
          <b> Falhas Críticas ReHe muitas vezes fazem com que a madeira se
            comporte de maneira contrária aos desejos do magus.</b>
          </p>
        </div>
      </div>
